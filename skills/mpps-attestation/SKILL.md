...
description: "Free, no-auth attestation. Prove what your agent did — one HTTP call, HSM-signed, stored 10 years."
license: MIT
metadata:
  author: gdlg-ai
  version: "1.0.4"
...
# receipt["timestamp"]  → "2026-03-20T07:48:19.546Z"
...
## Certified attestation ($0.01)

For rich metadata, human-readable certificates, and attestation chains:
...
# 10 free/day, then $0.01 via MPP (card or USDC on Tempo)
```
